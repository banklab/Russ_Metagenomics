...
cluster_df <- data.frame(array(NA, dim=c(length(cluster_list), 10), dimnames=list(c(),c("drep","cluster","LR28SR70","LR28","SR70","SR28","genome.LR28SR70","n.LR28","n.SR70","n.SR28"))))
