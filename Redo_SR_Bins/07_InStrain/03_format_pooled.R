...
for(DEER in 1:7){
  ...
  snv_file <- data.frame(fread(paste0("deer",DEER,"_env",EnvA,"_env",EnvB,"_SR_InStrain_SNVs.tsv"), header=T, stringsAsFactors = F))
...
write.csv(full_df, paste0("Pooled_Env",EnvA,"_Env",EnvB,"_SR_snps.csv"), row.names = F)
