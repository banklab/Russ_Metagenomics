...
combined_df <- data.frame(fread(paste0(SPECIES, "_Env",EnvA,"xEnv",EnvB,"_Combined_Sites.csv"), header=T, stringsAsFactors = F))
...
write.csv(filter_df4, paste0(SPECIES,"_Env",EnvA,"xEnv",EnvB, "_Filtered_Sites.csv"), row.names = F)
